...
export const MainHome = () => {
  return <div className="w-full bg-gray-900 bg-gradient-to-b text-stone-300 pt-20 font-montserrat">
      ...
      <div className='flex justify-evenly mt-64'>
        ...
        <button className='border-blue-900 border-4 text-blue-900 bg-blue-600 p-5 text-2xl hover:-translate-y-2 duration-300 ease-in-out shadow-xl' > 
          Learn More About My Software 
        </button>
      </div>

      <div className='hover:brightness-150 hover:translate-y-2 duration-300 ease-in-out'>
        <h2 className='text-center font-light text-4xl text-cyan-700 mt-48 w-fit mr-auto ml-auto'>
          More About Me
        </h2>
      ...
      <section className='ml-12'>
        <h2 className='font-bold text-4xl p-3 m-6'>Who I Am</h2>
